...
public class ViewBookedHotel extends JFrame implements ActionListener{
    JLabel text, lblusername,lbldays, lblac,lbladdress, lblgender, lblcountry, lblid, lblnumber, lblname;
    JLabel labelusername,labelac,labeldays, labelnumber, labelpersons, labelpackage, labelprice, labelid, labelphone;
    JButton back;
    String username;
    ...
    ViewBookedHotel(String username){
        ...
        lbldays.setBounds(30, 210, 200, 25);
        lbldays.setFont(new Font("Tahoma", Font.BOLD, 15));
        add(lbldays);
        
        labeldays = new JLabel();
        labeldays.setBounds(220, 210, 200, 25);
        add(labeldays);
        
        lblac = new JLabel ("AC/Non-AC");
        lblac.setBounds(30, 260, 200, 25);
        lblac.setFont(new Font("Tahoma", Font.BOLD, 15));
        add(lblac);
        
        labelac = new JLabel();
        labelac.setBounds(220, 260, 200, 25);
        add(labelac);
        
        JLabel lblfood = new JLabel ("Food Included?");
        lblfood.setBounds(30, 310, 200, 25);
        lblfood.setFont(new Font("Tahoma", Font.BOLD, 15));
        add(lblfood);
        
        JLabel labelfood = new JLabel();
        labelfood.setBounds(220, 310, 200, 25);
        add(labelfood);
        
        lblname = new JLabel ("Id");
        lblname.setBounds(30, 360, 200, 25);
        lblname.setFont(new Font("Tahoma", Font.BOLD, 15));
        add(lblname);
        
        labelid = new JLabel();
        labelid.setBounds(220, 360, 200, 25);
        add(labelid);
        
        lblgender = new JLabel ("Number");
        lblgender.setBounds(30, 410, 200, 25);
        lblgender.setFont(new Font("Tahoma", Font.BOLD, 15));
        add(lblgender);
        
        labelnumber = new JLabel();
        labelnumber.setBounds(220, 410, 200, 25);
        add(labelnumber);
        
        lblcountry = new JLabel ("Phone");
        lblcountry.setBounds(30, 460, 200, 25);
        lblcountry.setFont(new Font("Tahoma", Font.BOLD, 15));
        add(lblcountry);
        
        labelphone = new JLabel();
        labelphone.setBounds(220, 460, 200, 25);
        add(labelphone);
        
        lbladdress = new JLabel ("Price");
        lbladdress.setBounds(30, 510, 200, 25);
        lbladdress.setFont(new Font("Tahoma", Font.BOLD, 15));
        add(lbladdress);
        
        labelprice = new JLabel();
        labelprice.setBounds(220, 510, 200, 25);
        add(labelprice);
   
        back = new JButton("Back");
        back.setBounds(160, 570, 100, 25);
        ...
        image.setBounds(380, 80, 500, 430);
        add(image);
