...
public class Login extends JFrame implements ActionListener{
    ...
    Login() {
        ...
        lblpassword.setBounds(80, 110, 100, 25);
        ...
        login.setBackground(new Color(102, 181, 232));
        ...
        signup.setBackground(new Color(102, 181, 232));
        ...
        password.setBackground(new Color(102, 181, 232));
        ...
        text.setFont(new Font("SAN SERIF", Font.PLAIN, 10));
        p2.add(text);
