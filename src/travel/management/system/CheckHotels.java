...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run() {
        String[] text = new String[]{"The Taj Hotel", "JW Marriott Hotel", "ITC Royal Bengal", "Hyatt Regency", "Mandarin Oriental Hotel",  "Raddisson Blue Hotel", "Sonar Bangla", "Classio Hotel",  "The Golden Leaf", "The Kanchanjangha Range"};
        try {
            for (int i=0; i<9; i++){
    ...
    CheckHotels (){
        ...
        caption = new JLabel("");
        caption.setBounds(300, 500, 900, 70);
