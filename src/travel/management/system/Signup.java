...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup() {
        ...
        tfusername.setBounds(230, 20, 180, 25);
        ...
        tfname.setBounds(230, 60, 180, 25);
        ...
        tfpassword.setBounds(230, 100, 180, 25);
        tfpassword.setBorder(BorderFactory.createEmptyBorder());
        p1.add(tfpassword);
        
        JLabel lblsecurity = new JLabel ("Security Question");
        lblsecurity.setBounds(40, 140, 155, 25);
        ...
        security.setBounds(230, 140, 180, 25);
        p1.add(security);
        ...
        tfanswer.setBounds(230, 180, 180, 25);
        ...
        create.setForeground(new Color(102, 181, 232));
        ...
        back.setForeground(new Color(102, 181, 232));
        ...
        image.setBounds(500, 12, 400, 300);
        add(image);
